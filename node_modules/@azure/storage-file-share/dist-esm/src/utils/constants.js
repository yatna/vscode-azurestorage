...
export var FILE_MAX_SIZE_BYTES = 1024 * 1024 * 1024 * 1024; // 1TB
export var FILE_RANGE_MAX_SIZE_BYTES = 4 * 1024 * 1024; // 4MB
...
export var ETagNone = "";
export var ETagAny = "*";
export var StorageFileLoggingAllowedHeaderNames = [
...
export var StorageFileLoggingAllowedQueryParameters = [
    "comp",
    "maxresults",
    "rscc",
    "rscd",
