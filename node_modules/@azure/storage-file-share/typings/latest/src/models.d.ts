...
export declare function fileCreationTimeToString(time: Date | TimeNowType | TimePreserveType): string;
export declare function fileLastWriteTimeToString(time: Date | TimeNowType | TimePreserveType): string;
