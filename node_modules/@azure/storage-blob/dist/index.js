...
function createSpan(operationName, tracingOptions) {
    ...
    var spanOptions = tslib.__assign(tslib.__assign({}, tracingOptions.spanOptions), { kind: types.SpanKind.INTERNAL });
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (e_2.statusCode === 404) {
                            span.setStatus({
                                code: types.CanonicalCode.NOT_FOUND,
