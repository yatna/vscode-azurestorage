...
class StorageAccountListStep extends AzureWizardPromptStep_1.AzureWizardPromptStep {
    ...
    prompt(wizardContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const picksTask = this.getQuickPicks(client.storageAccounts.list());
            let result;
            do {
                result = (yield extensionVariables_1.ext.ui.showQuickPick(picksTask, quickPickOptions)).data;
                // If result is a string, that means the user selected the 'Learn more...' pick
                if (util_1.isString(result)) {
                    yield openUrl_1.openUrl(result);
                }
            } while (util_1.isString(result));
